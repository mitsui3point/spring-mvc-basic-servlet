...
@SpringBootTest
public class FrontControllerServletV4Test {

    private static final String prefixUri = "/front-controller/v4";
    ...
    void formProcessTest() throws ServletException, IOException {
        ...
        new FrontControllerServletV4().service(request, response);
