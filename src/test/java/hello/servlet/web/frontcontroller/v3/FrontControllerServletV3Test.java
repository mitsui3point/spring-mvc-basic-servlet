...
@SpringBootTest
public class FrontControllerServletV3Test {

    private static final String prefixUri = "/front-controller/v3";
    ...
    void formProcessTest() throws ServletException, IOException {
        ...
        new FrontControllerServletV3().service(request, response);
