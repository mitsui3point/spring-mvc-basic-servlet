...
@WebMvcTest
public class SpringMemberControllerV3Test {
    ...
    void formTest() throws Exception {
        //given
        //when
        ResultActions perform = mvc.perform(get("/springmvc/v3/members/new-form"));
        //then
        perform.andDo(print())
    ...
    void saveTest() throws Exception {
        ...
        ResultActions perform = mvc.perform(
                post("/springmvc/v3/members/save")
    ...
    void listTest() throws Exception {
        ...
        //when
        ResultActions perform = mvc.perform(get("/springmvc/v3/members"));
